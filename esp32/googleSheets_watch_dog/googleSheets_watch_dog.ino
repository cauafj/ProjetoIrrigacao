...
const float DRY = 40; //limiar de umidade - seco
const float SOAKED = 70; //limiar de umidade - molhado
...
const char *ssid = "ifrs-oso.Convidados";
const char *pass = "campusosorio";
